...
inputdir="../01_input/QUO1007029/testOneSample"

#Metadata file. This pulls the metadata path and file from the command line
metadata=$1

#This is where the ht2 files live:
hisat2path="/pl/active/conant-csu/gwmck@colostate.edu/PROJ02_QUO1007029_genomes/8f981"

#This is where the genome sequence lives:
genomefa="/pl/active/conant-csu/gwmck@colostate.edu/PROJ02_QUO1007029_genomes/cultureID-8f981.metaspades.fasta"

#This is where the gtf file lives:
gtffile="/pl/active/conant-csu/gwmck@colostate.edu/PROJ02_QUO1007029_genomes/cultureID-8f981.gtf"
...
cmd4="featureCounts -t "CDS" -p -T $pthread -a $gtffile -o ${outfeature}counts.txt ${samfilePath[*]}"
echo -e "\t$ $cmd4"
time eval $cmd4
